                ...
                for (int r = 0; r < radii.Length; ++r)
                {
                    ...
                    try
                    {
                        if (pathlines[idx].Length < 1 || pathlines[idx + 1].Length < 1 || pathlines[idx + 2].Length < 1 || pathlines[idx + 3].Length < 1 ||
                            pathlines[idx].Last.Z == 0 || pathlines[idx + 1].Last.Z == 0 || pathlines[idx + 2].Last.Z == 0 || pathlines[idx + 3].Last.Z == 0)
                        {
                        ...
                        maxEndTime = Math.Min(
                            Math.Min(pathlines[idx + 0].Last.Z, pathlines[idx + 1].Last.Z),
                            Math.Min(pathlines[idx + 2].Last.Z, pathlines[idx + 3].Last.Z));
                    }
                    catch (Exception e)
                    { Console.WriteLine("Vad händer här?"); }

                    Vector3 diffX = (Vector3)pathlines[idx + 0].SampleZ(maxEndTime) - (Vector3)pathlines[idx + 1].SampleZ(maxEndTime);
                    Vector3 diffY = (Vector3)pathlines[idx + 2].SampleZ(maxEndTime) - (Vector3)pathlines[idx + 3].SampleZ(maxEndTime);
                    ...
                    fx[r] = (float)(Math.Log(Math.Sqrt(lMax)) / (maxEndTime - integrationStart));
