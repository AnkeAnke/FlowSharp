...
//        /// </summary>
//    class VectorFieldBlock : VectorField
//    {
//        #region VF
//        protected VectorArray _data;
//        public override FieldGrid Grid { get; protected set; }

//        /// <summary>
//        /// Number of dimensions per vector.
//        /// </summary>
//        public override int NumVectorDimensions { get { return _data.VectorLength; } }

//        public override float? InvalidValue { get; set; }
//        public override float? TimeSlice { get; set; }
...
//        public VectorFieldBlock(VectorArray data, FieldGrid grid)
//        {
//            _data = data;
//            Grid = grid;
//            SpreadInvalidValue();
...
//        public VectorFieldBlock(VectorField field, VFJFunction function, int outputDim, bool needJacobian = true)
//        {
//            int scalars = outputDim;/*function(field.Sample(0), field.SampleDerivative(new Vector(0, field.Size.Length))).Length;*/
//            _data = new VectorArray(field.NumVectorDimensions, field.Size.Product());
...
//            VectorFieldBlock newField = new VectorFieldBlock(new VectorArray(NumVectorDimensions, newSize.Product()), sliceGrid);

//            Array.Copy(_data.Data, newSize.Product() * posInLastDimension, newField._data.Data, 0, newSize.Product());
//            return newField;
//        }

//        //public virtual VectorFieldBlock GetSlicePlanarVelocity(int posInLastDimension)
//        //{
...
//        //    }
//        //    return new VectorFieldBlock(slices);
//        //}
...
//            protected VectorFieldBlock _field;
//            /// <summary>
...
//            public virtual VectorFieldBlock Field { get { return _field; } set { _field = value; } }
//            /// <summary>
//            /// Based on CellSize equals (StepSize = 1).
//            /// </summary>
...
//            public static Integrator CreateIntegrator(VectorFieldBlock field, Type type, Line core = null, float force = 0.1f)
//            {
//                switch (type)
//                {
...
//        {
//            public IntegratorEuler(VectorFieldBlock field)
//            {
//                Field = field;
//            }
//            int counter = 0;
...
//        {
//            public IntegratorRK4(VectorFieldBlock field) : base(field)
//            { }
...
//            public IntegratorRK4Repelling(VectorFieldBlock field, Line core, float outwardForce) : base(field)
//            {
//                Core = core;
//                Force = outwardForce;
//            }
...
//        //    public IntegratorPredictorCorrector(VectorFieldBlock field, Predictor predictor, Corrector corrector, bool needJ = true) : base(field)
//        //    {
//        //        _predict = predictor;
//        //        _correct = corrector;
//        //        _computeJ = needJ;
