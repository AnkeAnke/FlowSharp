...
namespace FlowSharp
{
    ...
    /// </summary>
    class VectorField ///<DataType> where DataType : VectorData, new()
    {
        #region VF
    ...
    /// <summary>
    /// Abstract class for acessing vector fields. Memory management will differ.
    /// </summary>
    //interface AnyVectorField
    //{
    //    FieldGrid Grid { get; set; }
    //    Index Size { get; }
    ...
    //    /// Access field by scalar index.
    //    /// </summary>
    //    Vector this[int index] { get; set; }
    //    /// <summary>
    //    /// Access field by N-dimensional index.
    //    /// </summary>
    //    Vector this[Index gridPosition] { get; set; }

    //    /// <summary>
    //    /// Number of dimensions per vector.
    //    /// </summary>
    //    int NumVectorDimensions { get; }

    //    float? InvalidValue { get; set; }
    //    float? TimeSlice { get; set; }
    //    bool IsValid(Index pos);
    //    bool IsValid(Vector pos);
    //    /// <summary>
    //    /// Access field by scalar index.
    //    /// </summary>
    //    Vector Sample(int index);

    //    /// <summary>
    //    /// Access field by N-dimensional index.
    //    /// </summary>
    //    Vector Sample(Index gridPosition);

    //    Vector Sample(Vector position);
    ...
    //    /// <param name="pos"></param>
    //    /// <returns></returns>
    //    SquareMatrix SampleDerivative(Index pos);

    //    SquareMatrix SampleDerivative(Vector position);

    //    #endregion Access
    //    /// <summary>
    //    /// Make sure the invalid value is in the first scalar field if it is anywhere.
    //    /// </summary>
    //    void SpreadInvalidValue();

    //    AnyVectorField GetSlice(int posInLastDimension);
    //}
}