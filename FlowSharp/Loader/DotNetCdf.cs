...
namespace Microsoft.Research.ScientificDataSet.NetCDF4
{
    public static partial class NetCDF
    {
        ...
        [DllImport("netcdf4.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int nc_inq_grps(int ncid, out int numGrps, int[] ncids);
        [DllImport("netcdf4.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int nc_inq_grpname(int ncid, StringBuilder name);

        [DllImport("netcdf4.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int nc_inq_var_endian(int ncid, int varid, out NcEndian endianp);
    }
